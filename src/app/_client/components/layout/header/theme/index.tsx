    ...
    return (
      <div className="theming">
        <fieldset className="relative w-16 h-[26px] rounded-full shadow-[inset_0_2px_6px_1px_rgba(0,0,0,0.3)] bg-white dark:bg-purple_main">
          ...
          <div className="transition-transform rounded-full w-[52px] h-[52px] cursor-pointer top-1/2 -translate-y-1/2 -left-3 place-content-center bg-header_bg dark:bg-[#1e1f22] absolute grid shadow z-10">
